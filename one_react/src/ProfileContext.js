...
export const ProfileProvider = ({ children }) => {
    // Add weight to the profile state
            ...
            const fetchProfile = async () => {
                ...
                if (!userId) {
                    setProfile({ 
                        userId: 19, // Assign guest user ID
                        username: 'Guest', 
                        profileImage: `${process.env.REACT_APP_API_URL}/uploads/default_img.png`, // Correct default image for guests
                        weight: null,
                        email: null,
                        provider: null,
                        real_name: null
