...
router.post('/predictions', async (req, res) => {
    let { userId, predictedStartDate, predictedEndDate } = req.body;

    // If userId is not provided in the body, try to get it from the session (for guest users)
    if (!userId && req.session.guestUserId !== undefined) {
...
router.post('/pedometer', async (req, res) => {
    let { userId, date, steps, weight } = req.body;
